...
#else
typedef double x86_m128d __attribute__ ((__vector_size__ (16))) __attribute__((aligned(16)));
#endif
#endif
...
#else
typedef float x86_m128 __attribute__ ((__vector_size__ (16))) __attribute__((aligned(16)));
typedef int x86_m128i __attribute__ ((__vector_size__ (16))) __attribute__((aligned(16)));
#endif
