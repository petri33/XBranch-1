...
#define M_SQRT1_2f  0.707106781f
...
#define exp_1_8   make_float2(  1.0f, -1.0f )//requires post-multiply by 1/sqrt(2)
#define exp_1_4   make_float2(  0.0f, -1.0f )
#define exp_3_8   make_float2( -1.0f, -1.0f )//requires post-multiply by 1/sqrt(2)
...
#define iexp_1_8   make_float2(  1.0f, 1.0f )//requires post-multiply by 1/sqrt(2)
#define iexp_1_4   make_float2(  0.0f, 1.0f )
#define iexp_3_8   make_float2( -1.0f, 1.0f )//requires post-multiply by 1/sqrt(2)
...
inline __device__ void FFT8( float2 *a )
{
    ...
    a[5] = ( a[5] * exp_1_8 ) * M_SQRT1_2f;
    a[6] =   a[6] * exp_1_4;
    a[7] = ( a[7] * exp_3_8 ) * M_SQRT1_2f;
...
inline __device__ void IFFT8( float2 *a )
{
    ...
    a[5] = ( a[5] * iexp_1_8 ) * M_SQRT1_2f;
    a[6] =   a[6] * iexp_1_4;
    a[7] = ( a[7] * iexp_3_8 ) * M_SQRT1_2f;

    IFFT4( a[0], a[1], a[2], a[3] );
    IFFT4( a[4], a[5], a[6], a[7] );
}

inline __device__ void IFFT8j( float2 *a )
{
    IFFT2( a[0], a[4] );
    IFFT2( a[1], a[5] );
    IFFT2( a[2], a[6] );
...
inline __device__ void FFT16( float2 *a )
{
    ...
    a[7]  = (a[7]  * exp_3_8 ) * M_SQRT1_2f;
    a[9]  =  a[9]  * exp_1_16;
    a[10] = (a[10] * exp_1_8 ) * M_SQRT1_2f;
    a[11] =  a[11] * exp_3_16;
    a[13] =  a[13] * exp_3_16;
    a[14] = (a[14] * exp_3_8 ) * M_SQRT1_2f;
    a[15] =  a[15] * exp_9_16;
...
inline __device__ void IFFT16( float2 *a )
{
    ...
    a[7]  = (a[7]  * iexp_3_8 ) * M_SQRT1_2f;
    a[9]  =  a[9]  * iexp_1_16;
    a[10] = (a[10] * iexp_1_8 ) * M_SQRT1_2f;
    a[11] =  a[11] * iexp_3_16;
    a[13] =  a[13] * iexp_3_16;
    a[14] = (a[14] * iexp_3_8 ) * M_SQRT1_2f;
    a[15] =  a[15] * iexp_9_16;
...
#pragma unroll
    for( int j = 1; j < radix; j++ )
        a[j] = a[j] * exp_i((-2*M_PIf*rev<radix>(j)/n)*i);
}
...
{
    float2 w1 = exp_i((-2*M_PIf/32)*i);
    a[1]  = a[1]  * w1;
    a[5]  = a[5]  * w1;
    a[9]  = a[9]  * w1;
    a[13] = a[13] * w1;
    
    float2 w2 = exp_i((-1*M_PIf/32)*i);
    a[2]  = a[2]  * w2;
    a[6]  = a[6]  * w2;
    a[10] = a[10] * w2;
    a[14] = a[14] * w2;
    
    float2 w3 = exp_i((-3*M_PIf/32)*i);
    a[3]  = a[3]  * w3;
    a[7]  = a[7]  * w3;
    a[11] = a[11] * w3;
    a[15] = a[15] * w3;
